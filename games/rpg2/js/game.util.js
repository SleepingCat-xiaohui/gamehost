...
var GameData = {
	heros: {
		Aimee: ['heros1', 'heroFaces1', 0], //艾米
		Ailice: ['heros1', 'heroFaces1', 1], //爱丽丝

		Joy: ['heros1', 'heroFaces1', 2], // 乔伊
		Katherine: ['heros1', 'heroFaces1', 3] // 凯瑟琳
	},
	monsters: {},
	audios: [], // audios
	mapData: {
...
var Util = {
	...
	addHero: function(key, x, y, isNPC) {
		var hero = game.add.sprite(x, y, key[0], key[2]);
		hero.animations.add('left', [key[2] * 3 + 12, key[2] * 3 + 13, key[2] * 3 + 14, key[2] * 3 + 13], 6, true);
		hero.animations.add('right', [key[2] * 3 + 24, key[2] * 3 + 25, key[2] * 3 + 26, key[2] * 3 + 25], 6, true);
		hero.animations.add('up', [key[2] * 3 + 36, key[2] * 3 + 37, key[2] * 3 + 38, key[2] * 3 + 37], 6, true);
		hero.animations.add('down', [key[2] * 3 + 0, key[2] * 3 + 1, key[2] * 3 + 2, key[2] * 3 + 1], 6, true);
		return hero;
	},
